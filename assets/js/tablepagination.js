 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			...
			rowsPerPage : 10,
			currPage : 1,
			optionsForRows : [5,10,25,30,40,50,100],
			ignoreRows : [],
			topNav : false
		};  
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<label>Pagination</label>");
        htmlBuffer.push("<div id='tablePagination_perPage'>");
        ...
        htmlBuffer.push("<div id='tablePagination_paginater'>");
       	htmlBuffer.push("<span id='tablePagination_firstPage' class='icon glyphicon glyphicon-fast-backward'></span>");
       	htmlBuffer.push("<span id='tablePagination_prevPage' class='icon glyphicon glyphicon-backward'></span>");
        htmlBuffer.push("<input id='tablePagination_currPage' class='filter_select' type='input' value='"+currPageNumber+"' size='1'>");
        htmlBuffer.push(" / <span id='tablePagination_totalPages'><b>"+totalPages+"</b> Halaman</span>");
       	htmlBuffer.push("<span id='tablePagination_nextPage' class='icon glyphicon glyphicon-forward'></span>");
       	htmlBuffer.push("<span id='tablePagination_lastPage' class='icon glyphicon glyphicon-fast-forward'></span>");
        htmlBuffer.push("</div>");
        htmlBuffer.push("</div>");
